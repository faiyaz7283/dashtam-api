"""Alembic environment configuration for Dashtam.

This module configures Alembic to work with async SQLAlchemy and SQLModel.
...
# Import SQLModel to get all model metadata
...
# Set target_metadata to SQLModel's metadata for autogenerate support
...
def do_run_migrations(connection: Connection) -> None:
    ...
    context.configure(
        ...
        target_metadata=target_metadata,
        compare_type=True,  # Detect column type changes (e.g., TIMESTAMP -> TIMESTAMPTZ)
        compare_server_default=True,  # Detect default value changes
    )
