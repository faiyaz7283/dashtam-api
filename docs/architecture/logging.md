...
For compliance audit trails, see `audit.md`. For workflow
coordination, see `domain-events.md`.
...
- `audit.md` - Compliance audit logging (7+ year retention)
- `domain-events.md` - Event-driven workflow coordination
- `error-handling.md` - Result types and error mapping
- `dependency-injection.md` - Container pattern and DI strategy
