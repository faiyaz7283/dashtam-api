...
- **Pattern Documentation**: `docs/architecture/registry-pattern-architecture.md`
- **Provider Guide**: `docs/guides/adding-new-providers.md`
- **Domain Events Registry**: `docs/architecture/domain-events-architecture.md` (F7.7 - similar pattern)
