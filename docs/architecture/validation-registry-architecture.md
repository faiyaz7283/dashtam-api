...
**Pattern Reference**: `docs/architecture/registry-pattern-architecture.md`
...
- **Domain Events Registry** - `docs/architecture/domain-events-architecture.md` (Section 5.1)
- **Provider Registry** - `docs/architecture/provider-registry-architecture.md`
- **Rate Limit Registry** - `docs/architecture/rate-limit-architecture.md` (Section 5)

### Registry Pattern Documentation

- **Registry Pattern Theory** - `docs/architecture/registry-pattern-architecture.md`
- **Implementation Guide** - `docs/architecture/registry-pattern-architecture.md` (Section: Implementation Guide)
- **Best Practices** - `docs/architecture/registry-pattern-architecture.md` (Section: Best Practices)
