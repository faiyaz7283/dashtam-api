...
- [Components](#components)
  - [Component 1: GitHub Actions Workflow](#component-1-github-actions-workflow)
  - [Component 2: CI Docker Environment](#component-2-ci-docker-environment)
  - [Component 3: Codecov Integration](#component-3-codecov-integration)
  - [Component 4: Branch Protection](#component-4-branch-protection)
...
- [Setup Instructions](#setup-instructions)
  ...
  - [Installation Steps](#installation-steps)
    - [Step 1: Configure Workflow File](#step-1-configure-workflow-file)
    - [Step 2: Configure CI Environment](#step-2-configure-ci-environment)
    - [Step 3: Enable Branch Protection](#step-3-enable-branch-protection)
...
- [Troubleshooting](#troubleshooting)
  - [Issue 1: Workflow Not Running](#issue-1-workflow-not-running)
  - [Issue 2: Tests Failing in CI but Pass Locally](#issue-2-tests-failing-in-ci-but-pass-locally)
  - [Issue 3: Codecov Upload Failing](#issue-3-codecov-upload-failing)
  - [Issue 4: Branch Protection Preventing Merge](#issue-4-branch-protection-preventing-merge)
