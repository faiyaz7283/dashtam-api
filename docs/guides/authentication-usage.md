...
- Architecture: `docs/architecture/authentication-architecture.md` (why/what)
- Session Management: `docs/guides/session-management-usage.md`
- Authorization: `docs/guides/authorization-usage.md`
