...
- Update architecture document (`docs/architecture/transaction-domain-model.md`)
...
- Architecture: `docs/architecture/transaction-domain-model.md`
- Import Guidelines: `docs/guides/import-guidelines.md`
