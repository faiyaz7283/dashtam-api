...
**Architecture Reference**: `docs/architecture/secrets-management-architecture.md`
...
# See docs/architecture/secrets-management-architecture.md Section 11
```
...
- `docs/architecture/secrets-management-architecture.md` - Full architecture details
- `docs/architecture/dependency-injection-architecture.md` - Container patterns
