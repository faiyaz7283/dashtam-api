...
class TestGetLoggerContainer:
    ...
    def test_get_logger_returns_console_adapter_in_development(self):
        ...
        with patch("src.core.container.settings") as mock_settings:
            ...
            with patch("src.infrastructure.logging.console_adapter.ConsoleAdapter") as mock_console:
    ...
    def test_get_logger_returns_cloudwatch_adapter_in_production(self):
        ...
        with patch("src.core.container.settings") as mock_settings:
            ...
            with patch("src.infrastructure.logging.cloudwatch_adapter.CloudWatchAdapter") as mock_cloudwatch:
                mock_adapter = MagicMock()
