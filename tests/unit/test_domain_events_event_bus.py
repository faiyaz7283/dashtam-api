...
class TestInMemoryEventBusBasicFlow:
    ...
    async def test_subscribe_and_publish_single_handler(self):
        ...
        event = UserRegistrationSucceeded(user_id=uuid4(), email="test@example.com")
...
class TestInMemoryEventBusEdgeCases:
    ...
    async def test_publish_multiple_events_in_sequence(self):
        ...
        event1 = UserRegistrationSucceeded(user_id=uuid4(), email="user1@example.com")
        event2 = UserRegistrationSucceeded(user_id=uuid4(), email="user2@example.com")
        event3 = UserRegistrationSucceeded(user_id=uuid4(), email="user3@example.com")
